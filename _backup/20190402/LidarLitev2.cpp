...
{
    if (fast)
        i2c.frequency(400000); //I2C @ 400kHz
    else
        i2c.frequency(100000); //I2C @ 100Khz
    wait(0.2);
}
...
int LidarLitev2::distance_mm(bool stablizePreampFlag, bool takeReference, int LidarLitev2_addr)
{
    // Standard read distance protocol without continuous
