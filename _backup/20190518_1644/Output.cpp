...

{
	...
	setServoPulse(8, rf.s0.angle(rf.s0.angle_ref));
	setServoPulse(9, rf.s1.angle(rf.s1.angle_ref));
	setServoPulse(10, rf.s2.angle(rf.s2.angle_ref));
	setServoPulse(4, rb.s0.angle(-rb.s0.angle_ref));
	setServoPulse(5, rb.s1.angle(rb.s1.angle_ref));
	setServoPulse(6, rb.s2.angle(rb.s2.angle_ref));
	setServoPulse(0, lb.s0.angle(lb.s0.angle_ref));
	setServoPulse(1, lb.s1.angle(lb.s1.angle_ref));
	setServoPulse(2, lb.s2.angle(lb.s2.angle_ref));
	setServoPulse(12, lf.s0.angle(-lf.s0.angle_ref));
	setServoPulse(13, lf.s1.angle(lf.s1.angle_ref));
	setServoPulse(14, lf.s2.angle(lf.s2.angle_ref));
