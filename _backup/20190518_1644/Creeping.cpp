...
//step_height：足を上げたときの高さ
{
    ...
    {
        /**********************タイマー制御用****************************/
        if (mode == 4 && i >= 3 && i <= 6 && state == 3)
        {
            ratio_left = 0.6;
            ratio_right = 1.0;
            pc.printf("Change ratio left\n");
        }
        else if (mode == 4 && i > 5 && state == 3)
        {
            ratio_left = 1.0;
            ratio_right = 0.94;
        }
        if (mode == 4 && i >= 7 && state == 4)
        {
            rf.adjust = 0.0;
            lf.adjust = 0.0;
        }
        if (mode == 4 && i == 2 && state == 2)
        {
            rf.adjust = 0.05;
            lf.adjust = 0.05;
            adjust_y = 0.05;
        ...
        else if (mode == 4 && i >= 4 && i <= 6 && state == 2)
        {
            ratio_left = 0.5;
            ratio_right = 1.0;
            pc.printf("Sand step 4\n");
        }
        else if (mode == 4 && i >= 7 && i <= 9
        ...
        /*
        if (mode == 4 && state == 2 && roll > 10)
        {
            rf.adjust = 0.01;
            lf.adjust = 0.01;
            adjust_y = 0.05;
        }
        else if (mode == 4 && state == 2)
        {
            rf.adjust = 0.0;
            lf.adjust = 0.0;
            adjust_y = ADJUST_Y;
