...
DigitalInOut Xshut[2] = {DigitalInOut(PC_2), DigitalInOut(PC_3)};

DigitalIn button_white(PH_1);       //白ボタン
DigitalIn button_red(PH_0);         //赤ボタン
DigitalIn button_blue_left(PA_13);  //青_1ボタン(左下)
DigitalIn button_blue_right(PA_14); //青_2ボタン(右下)
